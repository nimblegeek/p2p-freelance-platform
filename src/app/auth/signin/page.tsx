...
export default function SignIn() {
  ...
  const handleBankIDSuccess = async (user: any) => {
    try {
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-3">
              <button
                ...
                className="inline-flex justify-center w-full px-4 py-2 text-sm font-medium text-white bg-gray-800 border border-transparent rounded-md shadow-sm hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
              >
              ...
              >
                <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
                  ...
                  <path fill="#4A90E2" d="M19.834192,20.9995801 C22.0291676,18.9520994 23.4545455,15.903663 23.4545455,12 C23.4545455,11.2909091 23.3454545,10.5818182 23.1272727,9.90909091 L12,9.90909091 L12,14.7272727 L18.4363636,14.7272727 C18.1187732,16.6894157 17.2662994,18.0125889 16.0407269,18.0125889 L19.834192,20.9995801 Z" />
              ...
              <button
                ...
                className="inline-flex justify-center w-full px-4 py-2 text-sm font-medium text-white bg-black border border-transparent rounded-md shadow-sm hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black"
              >
